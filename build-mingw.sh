...
cmake -G "MinGW Makefiles" -D${PROJECT_NAME}_SYSNAME="mingw-w64" -DBUILD_SHARED_LIBS=On "-D${PROJECT_NAME}_BUILD_DLL=On" "-D${PROJECT_NAME}_PACKAGE=On" -DCMAKE_BUILD_TYPE=Release ..
